# Visual Feature Catalog

This directory contains a comprehensive collection of screenshots and UI/UX documentation for the Hira application. Each subdirectory focuses on a specific feature or module, providing a visual tour of the user experience.
...
| **Hadith** | [`hadith.png`](hadith/hadith.png), [`hadith-list.png`](hadith/hadith-list.png), [`hadith-detail.png`](hadith/hadith-detail.png) | [View Details](hadith/README.md) |
| **Tasbih** | [`tasbih-dzikir-daily.png`](tasbih/tasbih-dzikir-daily.png), [`tasbih-dzikir-check-list.png`](tasbih/tasbih-dzikir-check-list.png), [`tasbih-dzikir-all.png`](tasbih/tasbih-dzikir-all.png) | [View Details](tasbih/README.md) |

## 📈 Tracking & Progress
| Feature | Screenshot Inventory (Click to View) | Documentation |
| :--- | :--- | :--- |
| **Tracker** | [`tracker.png`](tracker/tracker.png) | [View Details](tracker/README.md) |
| **Khatam** | [`khatam.png`](khatam/khatam.png) | [View Details](khatam/README.md) |
| **Journal** | [`journal.png`](journal/journal.png) | [View Details](journal/README.md) |
| **Achievement** | [`achievements.png`](achievement/achievements.png), [`achievements-detail-1.png`](achievement/achievements-detail-1.png), [`achievements-share.png`](achievement/achievements-share.png), [`achievements-detail-lock-1.png`](achievement/achievements-detail-lock-1.png) | [View Details](achievement/README.md) |
| **Hijrah** | [`hijrah-dashboard-1.png`](hijrah/hijrah-dashboard-1.png), [`hijrah-mission-quiz.png`](hijrah/hijrah-mission-quiz.png), [`hijrah-achievement-list.png`](hijrah/hijrah-achievement-list.png), [`hijrah-step-1.png`](hijrah/hijrah-step-1.png) | [View Details](hijrah/README.md) |
...
| **Hajj & Umrah** | [`hajj-umrah.png`](hajj-umrah/hajj-umrah.png) / [`hajj-journey.png`](hajj-journey/hajj-journey.png) | [Journey](hajj-journey/README.md) / [Hajj-Umrah](hajj-umrah/README.md) |

## 📱 User Experience & Experience
| Feature | Screenshot Inventory (Click to View) | Documentation |
| :--- | :--- | :--- |
| **Home** | [`home-1.png`](home/home-1.png), [`home-search-1.png`](home/home-search-1.png), [`features-more-1.png`](home/features-more-1.png) | [View Details](home/README.md) |
| **AI Chat** | [`assistan.png`](ai-chat/assistan.png) | [View Details](ai-chat/README.md) |
| **Articles** | [`articles.png`](articles/articles.png), [`articles-detail.png`](articles/articles-detail.png) | [View Details](articles/README.md) |
| **Explore** | [`explore-1.png`](explore/explore-1.png), [`explore-search.png`](explore/explore-search.png) | [View Details](explore/README.md) |
| **Deen Mode** | [`deen-mode.png`](deen-mode/deen-mode.png) | [View Details](deen-mode/README.md) |
